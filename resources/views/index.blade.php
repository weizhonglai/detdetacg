    ...
    <div id="content">
        ...
        <div class="right_colmn">
            ...
            <div class="prod_listing">
                ...
                <ul>
                	<li>
                    	<a href="prod_detail.html"><img src="/templates/images/img1.gif" alt="" /></a>
                        <p class="title">Die Hard With A Vengeance</p>
                        <p class="price bold">GP $ 500, 00</p>
                        <a href="cart.html" class="button"><span>Buy Now</span></a>
                    </li>
                    <li>
                    	<a href="prod_detail.html"><img src="/templates/images/img2.gif" alt="" /></a>
                        <p class="title">Die Hard With A Vengeance</p>
                        <p class="price bold">GP $ 500, 00</p>
                        <a href="cart.html" class="button"><span>Buy Now</span></a>
                    </li>
                    <li>
                    	<a href="prod_detail.html"><img src="/templates/images/img3.gif" alt="" /></a>
                        <p class="title">Die Hard With A Vengeance</p>
                        <p class="price bold">GP $ 500, 00</p>
                        <a href="cart.html" class="button"><span>Buy Now</span></a>
                    </li>
                    <li>
                    	<a href="prod_detail.html"><img src="/templates/images/img4.gif" alt="" /></a>
                        <p class="title">Die Hard With A Vengeance</p>
                        <p class="price bold">GP $ 500, 00</p>
                        <a href="cart.html" class="button"><span>Buy Now</span></a>
                    </li>
...
<div id="footer">
	<div class="inner_sec">
        ...
        <div class="foot_sec last">
            ...
            <p>
            	Web Design and Development: <a href="#" class="designedby"><img src="/templates/images/flower.gif" alt="" /></a>
            </p>
            <ul class="cards">
